      ...
      <div className='justify-center'>
        {taskList.map(task => (
          <div key={task.id} className='bg-gray-700 rounded overflow-hidden my-3 mx-2 shadow-lg'>
            <button onClick={e => removeTask(task.id)} className='bg-gray-800 hover:bg-gray-400 text-black text-center py-1.5 px-2.5 rounded-full h-10 w-10 inline-flex items-center float-right m-2'>
              <svg className='h-6 w-6' fill='#000000' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 50 50' width='50px' height='50px'>
